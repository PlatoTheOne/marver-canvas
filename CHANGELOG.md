...
- **Boards open in seconds, not minutes.** A board of 128 lo-fi frames went from 77-95 s to
  under 8 s to fully ready, and its first frames show within the first second. Three causes,
  ...
  every frame loaded twice - it now counts from admission. A frame reports ready when React
  has committed, not when it was asked to render.
